...
**更新** 表格组件的字体大小配置现在会影响表格整体尺寸，提供更好的视觉一致性体验。当调整表格字体大小时，表格的行高、单元格内边距等会相应调整，确保文字在单元格内的垂直居中和整体视觉平衡。
...
BindCols --> FontSizeCheck{"字体大小已配置？"}
FontSizeCheck --> |是| AdjustSize["调整表格整体尺寸<br/>行高=字体大小×系数<br/>内边距=字体大小÷2"]
FontSizeCheck --> |否| UseDefault["使用默认字体大小<br/>12px"]
AdjustSize --> Done["完成"]
UseDefault --> Done
BindCols --> Done
```
